      ...
      properties: {
        ...
        policy: {
          ...
          properties: {
            ...
            maxDurationSeconds: { type: 'number', description: 'Hard cap on call duration (server enforces a ceiling).' },
            maxCostUsd: { type: 'number', description: 'Cost cap in USD — going over triggers costOverLimit.' },
            maxAttempts: { type: 'number', description: 'Max redial attempts (server caps this).' },
            ...
            alternativePolicy: {
              type: 'object',
              properties: {
                maxTimeShiftMinutes: { type: 'number', description: 'How far the agent may move a proposed appointment without re-asking the operator.' },
              },
              required: ['maxTimeShiftMinutes'],
            },
          },
          required: [
            'regionAllowlist', 'maxDurationSeconds', 'maxCostUsd', 'maxAttempts',
