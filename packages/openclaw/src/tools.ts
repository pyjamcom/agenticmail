  ...
  reg('agenticmail_call_phone', {
    ...
    parameters: {
      ...
      policy: {
        ...
        required: true,
        description: [
          'OpenClaw phone mission policy. Every field below is required; confirmPolicy and regionAllowlist use FIXED literal enums (don\'t guess synonyms).',
          'Minimal valid shape:',
          '{',
          ...
          '  "confirmPolicy": {',
          '    "paymentDetails": "never",                  // FIXED',
          '    "contractCommitment": "never",              // FIXED',
          '    "costOverLimit": "needs_operator",          // FIXED',
          '    "sensitivePersonalData": "needs_operator",  // FIXED',
          '    "unclearAlternative": "needs_operator"      // FIXED',
          '  },',
